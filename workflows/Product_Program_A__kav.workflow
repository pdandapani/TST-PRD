...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>PROD_Geography_CAN_Field_Update</fullName>
...
IF(INCLUDES( States_Provinces__c,&quot;Nunavut&quot;),&quot;Nunavut&quot;,&quot;&quot;)</formula>
        <name>PROD - Geography - CAN - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>PROD_Geography_MEX_Field_Update</fullName>
        <description>Country and state values converted via workflow to a searchable text field</description>
        <field>Geography_Keywords__c</field>
        <formula>TEXT(Country__c)&amp;&quot;,&quot;&amp; 
...
IF(INCLUDES( States_Provinces__c,&quot;Tlaxcala&quot;),&quot;Tlaxcala&quot;,&quot;&quot;)</formula>
        <name>PROD - Geography - MEX - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>PROD_Geography_Null_Field_Update</fullName>
        <description>Searchable text field updated to &apos;null&apos; when Country is &apos;none&apos;.</description>
        <field>Geography_Keywords__c</field>
        <name>PROD - Geography - Null - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <fieldUpdates>
        <fullName>PROD_Geography_USA_Field_Update</fullName>
        <description>Country and state values converted via workflow to a searchable text field</description>
        <field>Geography_Keywords__c</field>
        <formula>TEXT(Country__c)&amp;&quot;,&quot;&amp; 
...
IF(INCLUDES( States_Provinces__c,&quot;Wyoming&quot;),&quot;Wyoming&quot;,&quot;&quot;)</formula>
        <name>PROD - Geography - USA - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>PROD_PROG_FOPP_Field_Update</fullName>
        ...
        <name>PROD PROG - FOPP - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>PROD PROG - FOPP</fullName>
        <actions>
            <name>PROD_PROG_FOPP_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>Product_Program_A__kav.CreatedDate</field>
    ...
    <rules>
        <fullName>PROD PROG - Geography - CAN</fullName>
        <actions>
            <name>PROD_Geography_CAN_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>PROD PROG - Geography - MEX</fullName>
        <actions>
            <name>PROD_Geography_MEX_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>PROD PROG - Geography - Null</fullName>
        <actions>
            <name>PROD_Geography_Null_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>PROD PROG - Geography - USA</fullName>
        <actions>
            <name>PROD_Geography_USA_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
