...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>How_To_Caller_Type_Field_Update</fullName>
        <description>Caller Type values converted via workflow to a searchable text field</description>
        <field>Caller_Type_Keywords__c</field>
        <formula>IF(INCLUDES( Caller_Type__c ,&quot;Borrower / Co-Borrower&quot;),&quot;Borrower / Co-Borrower,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Business Account&quot;),&quot;Business Account,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Non-Signing Spouse&quot;),&quot;Non-Signing Spouse,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Toyota/Lexus/Scion/CCC Dealer&quot;),&quot;Toyota/Lexus/Scion/CCC Dealer,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Non-Toyota/Lexus/Scion/CCC Dealer&quot;),&quot;Non-Toyota/Lexus/Scion/CCC Dealer,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Third Party&quot;),&quot;Third Party,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Attorney&quot;),&quot;Attorney,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Law Enforcement&quot;),&quot;Law Enforcement,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Media&quot;),&quot;Media,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Insurance Company&quot;),&quot;Insurance Company,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Executor of Estate&quot;),&quot;Executor of Estate,&quot;,&quot;&quot;)&amp;
IF(INCLUDES( Caller_Type__c ,&quot;Credit Reporting Agencies&quot;),&quot;Credit Reporting Agencies,&quot;,&quot;&quot;)</formula>
        <name>How To - Caller Type - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>How_To_FOPP_Field_Update</fullName>
        ...
        <name>How To - FOPP - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>How_To_Geography_CAN_Field_Update</fullName>
...
IF(INCLUDES( States_Provinces__c,&quot;Nunavut&quot;),&quot;Nunavut&quot;,&quot;&quot;)</formula>
        <name>How To - Geography - CAN - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>How_To_Geography_MEX_Field_Update</fullName>
        <description>Country and state values converted via workflow to a searchable text field</description>
        <field>Geography_Keywords__c</field>
        <formula>TEXT(Country__c)&amp;&quot;,&quot;&amp; 
...
IF(INCLUDES( States_Provinces__c,&quot;Tlaxcala&quot;),&quot;Tlaxcala&quot;,&quot;&quot;)</formula>
        <name>How To - Geography - MEX - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>How_To_Geography_Null_Field_Update</fullName>
        <description>Searchable text field updated to &apos;null&apos; when Country is &apos;none&apos;.</description>
        <field>Geography_Keywords__c</field>
        <name>How To - Geography - Null - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <fieldUpdates>
        <fullName>How_To_Geography_USA_Field_Update</fullName>
        <description>Country and state values converted via workflow to a searchable text field</description>
        <field>Geography_Keywords__c</field>
        <formula>TEXT(Country__c)&amp;&quot;,&quot;&amp; 
...
IF(INCLUDES( States_Provinces__c,&quot;Wyoming&quot;),&quot;Wyoming&quot;,&quot;&quot;)</formula>
        <name>How To - Geography - USA - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>How To - Caller Type</fullName>
        <actions>
            <name>How_To_Caller_Type_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>How_To_A__kav.CreatedDate</field>
            <operation>lessOrEqual</operation>
            <value>TODAY</value>
        </criteriaItems>
        <description>Caller Type keyword conversion to text search</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>How To - FOPP</fullName>
        <actions>
            <name>How_To_FOPP_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>How To - Geography - CAN</fullName>
        <actions>
            <name>How_To_Geography_CAN_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>How To - Geography - MEX</fullName>
        <actions>
            <name>How_To_Geography_MEX_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>How To - Geography - Null</fullName>
        <actions>
            <name>How_To_Geography_Null_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>How To - Geography - USA</fullName>
        <actions>
            <name>How_To_Geography_USA_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
