...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>REF_FOPP_Field_Update</fullName>
        ...
        <name>REF - FOPP - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>REF_Geography_CAN_Field_Update</fullName>
...
IF(INCLUDES( States_Provinces__c,&quot;Nunavut&quot;),&quot;Nunavut&quot;,&quot;&quot;)</formula>
        <name>REF - Geography - CAN - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>REF_Geography_MEX_Field_Update</fullName>
        <description>Country and state values converted via workflow to a searchable text field</description>
        <field>Geography_Keywords__c</field>
        <formula>TEXT(Country__c)&amp;&quot;,&quot;&amp; 
...
IF(INCLUDES( States_Provinces__c,&quot;Tlaxcala&quot;),&quot;Tlaxcala&quot;,&quot;&quot;)</formula>
        <name>REF - Geography - MEX - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>REF_Geography_Null_Field_Update</fullName>
        <description>Searchable text field updated to &apos;null&apos; when Country is &apos;none&apos;.</description>
        <field>Geography_Keywords__c</field>
        <name>REF - Geography - Null - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <fieldUpdates>
        <fullName>REF_Geography_USA_Field_Update</fullName>
        <description>Country and state values converted via workflow to a searchable text field</description>
        <field>Geography_Keywords__c</field>
        <formula>TEXT(Country__c)&amp;&quot;,&quot;&amp; 
...
IF(INCLUDES( States_Provinces__c,&quot;Wyoming&quot;),&quot;Wyoming&quot;,&quot;&quot;)</formula>
        <name>REF - Geography - USA - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>REF - FOPP</fullName>
        <actions>
            <name>REF_FOPP_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>Reference_A__kav.CreatedDate</field>
    ...
    <rules>
        <fullName>REF - Geography - CAN</fullName>
        <actions>
            <name>REF_Geography_CAN_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>REF - Geography - MEX</fullName>
        <actions>
            <name>REF_Geography_MEX_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>REF - Geography - Null</fullName>
        <actions>
            <name>REF_Geography_Null_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>REF - Geography - USA</fullName>
        <actions>
            <name>REF_Geography_USA_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
