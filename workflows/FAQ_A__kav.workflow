...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>FAQ_Caller_Type_Field_Update</fullName>
...
IF(INCLUDES( Caller_Type__c ,&quot;Credit Reporting Agencies&quot;),&quot;Credit Reporting Agencies,&quot;,&quot;&quot;)</formula>
        <name>FAQ - Caller Type - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>FAQ_FOPP_Field_Update</fullName>
        ...
        <name>FAQ - FOPP - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>FAQ_Geography_CAN_Field_Update</fullName>
...
IF(INCLUDES( States_Provinces__c,&quot;Nunavut&quot;),&quot;Nunavut&quot;,&quot;&quot;)</formula>
        <name>FAQ - Geography - CAN - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>FAQ_Geography_MEX_Field_Update</fullName>
...
IF(INCLUDES( States_Provinces__c,&quot;Tlaxcala&quot;),&quot;Tlaxcala&quot;,&quot;&quot;)</formula>
        <name>FAQ - Geography - MEX - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>FAQ_Geography_Null_Field_Update</fullName>
        <description>Searchable text field updated to &apos;null&apos; when Country is &apos;none&apos;.</description>
        <field>Geography_Keywords__c</field>
        <name>FAQ - Geography - Null - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <fieldUpdates>
        <fullName>FAQ_Geography_USA_Field_Update</fullName>
        <description>Country and state values converted via workflow to a searchable text field</description>
        <field>Geography_Keywords__c</field>
        <formula>TEXT(Country__c)&amp;&quot;,&quot;&amp; 
...
IF(INCLUDES( States_Provinces__c,&quot;Wyoming&quot;),&quot;Wyoming&quot;,&quot;&quot;)</formula>
        <name>FAQ - Geography - USA - Field Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>FAQ - Caller Type</fullName>
        <actions>
            <name>FAQ_Caller_Type_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>FAQ_A__kav.CreatedDate</field>
    ...
    <rules>
        <fullName>FAQ - FOPP</fullName>
        <actions>
            <name>FAQ_FOPP_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>FAQ - Geography - CAN</fullName>
        <actions>
            <name>FAQ_Geography_CAN_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>FAQ - Geography - MEX</fullName>
        <actions>
            <name>FAQ_Geography_MEX_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>FAQ - Geography - Null</fullName>
        <actions>
            <name>FAQ_Geography_Null_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>FAQ - Geography - USA</fullName>
        <actions>
            <name>FAQ_Geography_USA_Field_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
